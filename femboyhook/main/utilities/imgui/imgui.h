...
struct ImDrawList
{
    ...
    IMGUI_API void AddConvexPolyFilledWithColors(const ImVec2* points, const int points_count, std::vector<ImU32> col);
    ...
    inline void PathFillConvexWithColors(ImU32 col1, ImU32 col2, ImU32 col3) { AddConvexPolyFilledWithColors(_Path.Data, _Path.Size, {col1, col2, col3}); _Path.Size = 0; }
