...
public:
	...
	virtual c_game_event* CreateEvent( const char* name, bool force, unsigned int unk )               = 0;
	...
	virtual bool serialize_event( c_game_event* event, bf_write1* buf )                               = 0;
	virtual c_game_event* unserialize_event( bf_read1* buf )                                          = 0;
};
